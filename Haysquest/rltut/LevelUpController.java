...
public class LevelUpController {
    ...
    private static LevelUpOption[] options = new LevelUpOption[]{
            ...
            new LevelUpOption("Increased regeneration"){
                public void invoke(Creature creature) { ((Warrior) creature).gainRegen();
                }
            }
        };

    public void autoLevelUp(Creature creature){
        options[(int)(Math.random() * options.length - 1)].invoke(creature);
    }
